...
namespace System.Net.WebSockets
{
    public sealed partial class ClientWebSocket : WebSocket
    {
        ...
        private readonly Managed.ClientWebSocketOptions _options;
        private Managed.WebSocketHandle _innerWebSocket; // may be mutable struct; do not make readonly
        ...
        public ClientWebSocket()
        {
            ...
            Managed.WebSocketHandle.CheckPlatformSupport();

            _state = (int)InternalState.Created;
            _options = new Managed.ClientWebSocketOptions();
        ...
        public Managed.ClientWebSocketOptions Options
        {
            get
            {
                return _options;
        ...
        public override WebSocketCloseStatus? CloseStatus
        {
            get
            {
                if (Managed.WebSocketHandle.IsValid(_innerWebSocket))
                {
        ...
        {
            _innerWebSocket = Managed.WebSocketHandle.Create();
